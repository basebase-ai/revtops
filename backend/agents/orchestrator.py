...
- `external_userid`: External user identifier (for Slack, this is U123...)
- `external_email`: External profile email when available
- `source`: Identity provider/source key (e.g., "slack", "revtops_unknown")
...
WHERE m.source = 'slack'
  AND m.external_userid = 'U12345678'
