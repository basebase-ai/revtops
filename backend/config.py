...
class Settings(BaseSettings):
    ...
    TOPIC_GRAPH_RETENTION_DAYS: int = 30
    ENABLE_NIGHTLY_TOPIC_GRAPH: bool = False
    NIGHTLY_TOPIC_GRAPH_CRON_UTC: str = "0 9 * * *"
    TOPIC_GRAPH_USE_CACHED_ONLY: bool = True
    TOPIC_GRAPH_SNIPPETS_PER_NODE: int = 10
    TOPIC_GRAPH_HEAT_UNIQUE_DOC_WEIGHT: float = 1.0
    TOPIC_GRAPH_HEAT_RECENCY_WEIGHT: float = 1.0
    TOPIC_GRAPH_HEAT_RECENCY_HALF_LIFE_HOURS: float = 24.0
    TOPIC_GRAPH_FUZZY_MERGE_MIN_CONFIDENCE: float = 0.5
