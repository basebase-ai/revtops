"""
External identity mapping — links RevTops users to external platform identities.

Used by **all** platforms (Slack, GitHub, HubSpot, Salesforce, Linear, etc.)
to resolve external user IDs / emails to internal RevTops users.

Table: ``user_mappings_for_identity``
"""
...
class ExternalIdentityMapping(Base):
    """Persisted mapping between RevTops users and external platform identities."""
